...
image:https://badges.gitter.im/unruhschuh/MrWriter.svg[link="https://gitter.im/unruhschuh/MrWriter?utm_source=badge&utm_medium=badge&utm_campaign=pr-badge&utm_content=badge"] image:https://travis-ci.com/unruhschuh/MrWriter.svg?branch=master["Build Status", link="https://travis-ci.com/unruhschuh/MrWriter"]
