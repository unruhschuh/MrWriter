...
apt install git python3-pip libgl1-mesa-dev pkg-config sudo cmake
...
expor tVERSION=$(git rev-parse --short HEAD) # linuxdeployqt uses this for naming the file
...
echo curl --upload-file "./${APPIMAGE}" http://transfer.sh/${APPIMAGE}
